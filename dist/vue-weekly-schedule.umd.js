...
(function (global, factory) {
  ...
  (global = global || self, factory(global.VueWeeklySchedule = {}, global.moment));
  ...
  var script = {
      ...
      eventsByDay: function eventsByDay() {
        ...
        this.schedules.forEach(function (schedule, index) {
          ...
          schedule.events.forEach(function (event) {
            var startHr = moment.duration(event.startTime).asHours();
            var endHr = moment.duration(event.endTime).asHours();
    ...
    methods: {
      addEvent: function () {
        ...
        /*#__PURE__*/
        regenerator.mark(function _callee(day) {
  ...
  var __vue_staticRenderFns__ = [];
    ...
    var WeeklySchedule = normalizeComponent_1(
